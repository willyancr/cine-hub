/*
  ...
  - Added the required column `userId` to the `Watched` table without a default value. This is not possible if the table is not empty.
...
*/
-- AlterTable
ALTER TABLE "Watched" ADD COLUMN     "userId" TEXT NOT NULL;
