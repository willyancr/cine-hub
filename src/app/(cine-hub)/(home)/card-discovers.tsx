  ...
  return (
    <div className="group/card w-full max-w-xs sm:max-w-sm md:max-w-md">
      <div
        ...
        className="card relative mx-auto flex h-60 w-full max-w-[350px] cursor-pointer flex-col justify-between overflow-hidden rounded-xl bg-cover p-4 shadow-xl sm:h-60 sm:max-w-[400px] md:h-68 xl:h-80 xl:max-w-[450px]"
      >
